...
func main() {
	...
	pdfTemp := templateExample("DP.xxx-api-key-xxx", "https://api.dynamicpdf.com/")
	process(pdfTemp,"c:/temp/dynamicpdf-api-samples/pdfTempExample.pdf")

//	pdfOut := outlineExample("DP.xxx-api-key-xxx", "https://api.dynamicpdf.com/")
//	process(pdfOut,"c:/temp/dynamicpdf-api-samples/pdfOutlineExample.pdf")	

//	pdfAcro := acroFormExample("DP.xxx-api-key-xxx", "https://api.dynamicpdf.com/")
//	process(pdfAcro,"c:/temp/dynamicpdf-api-samples/pdfAcroExample.pdf")

	//pdfD := dlexResourceExample("DP.xxx-api-key-xxx", "https://api.dynamicpdf.com/")
	//process(pdfD,"c:/temp/dynamicpdf-api-samples/pdfdlexExample.pdf")

	//pdfIm := imageExample("DP.xxx-api-key-xxx", "https://api.dynamicpdf.com/")
	//process(pdfIm,"c:/temp/dynamicpdf-api-samples/pdfImage.pdf")

	//pdfTlm := topLevelMetadata("DP.xxx-api-key-xxx", "https://api.dynamicpdf.com/")
	//process(pdfTlm, "c:/temp/dynamicpdf-api-samples/tlm.pdf")

	//pdfFnt := fontsExample("DP.xxx-api-key-xxx", "https://api.dynamicpdf.com/")
	//process(pdfFnt, "c:/temp/dynamicpdf-api-samples/fnt.pdf")

	//pdfBar := barcodeExample("DP.xxx-api-key-xxx", "https://api.dynamicpdf.com/")
	//process(pdfBar, "c:/temp/dynamicpdf-api-samples/bar.pdf")

//	pdfSec := securityExample("DP.xxx-api-key-xxx", "https://api.dynamicpdf.com/")
	//process(pdfSec, "c:/temp/dynamicpdf-api-samples/sec.pdf")

	//pdfPr := pdfFromResourceExample("DP.xxx-api-key-xxx", "https://api.dynamicpdf.com/")
